...
public class ClientRestController {
    ...
    public ClientResponse getByNomAndPrenom(@RequestParam String nom,
    ...
    public List<ClientResponse> bornBetween(@RequestParam String start,
    ...
    public List<ClientResponse> findPointsBetween(@RequestParam int min,
